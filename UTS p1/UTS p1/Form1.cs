...
namespace UTS_p1
{
    public partial class Form1 : Form
    {
        ...
        private int passwordLength = 1; // Panjang password yang akan dicoba
        ...
        private void BruteforceWorker_ProgressChanged(object sender, ProgressChangedEventArgs e)
        {
            ...
            // Penundaan 10 milidetik (0,010 detik) antara setiap pembaruan ListBox
        ...
        private void BruteforceWorker1_ProgressChanged(object sender, ProgressChangedEventArgs e)
        {
            ...
            // Penundaan 10 milidetik (0,01 detik) antara setiap pembaruan ListBox
            Thread.Sleep(500);  //simulating work
        }
        ...
        private void btnClear_Click(object sender, EventArgs e)
        {
            ...
            listBoxAttempts1.Items.Clear();
            listBoxAttempts2.Items.Clear();
